...
var K3dToolInfo = k3dToolInfo{}

type k3dToolInfo struct{}

func (k3dToolInfo) Name() string {
	return "k3d"
}

func (k3dToolInfo) ExecutableName() string {
	return "k3d"
}
...
func (i k3dToolInfo) GetVersion(tp tools.ToolProvider) (string, error) {
	if tp != nil {
		// do nothing
	...
	path, err := tools.ResolveTool(K3dToolInfo, DefaultToolVersion, tp)
	if err != nil {
		return "", err
	}
...
// to the tool
func (k3dToolInfo) GetVersionWithPath(path string) (string, error) {
